...
def convert_color(rgb, a, truncate=True):
    from pebble_image_routines import nearest_color_to_pebble2_palette, truncate_color_to_pebble2_palette, \
        rgba32_triplet_to_argb8

    r, g, b = (rgb >> 16) & 0xFF, (rgb >> 8) & 0xFF, rgb & 0xFF
    if truncate:
        (r, g, b, a) = truncate_color_to_pebble2_palette(r, g, b, a)
    else:
        (r, g, b, a) = nearest_color_to_pebble2_palette(r, g, b, a)
        ...
        if tag == 'layer' or tag == 'g':
            ...
            if tag == 'g':
              ...
              if group_stroke_width:
                group_stroke_width = int(float([x for x in group_stroke_width if x in '0123456789.']))
